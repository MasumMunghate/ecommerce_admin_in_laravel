...
(function () {
  ...
  flatpickrDates = document.querySelector('#flatpickr-dates'),
  birthdayDate = document.querySelector('#birthday-date'),
  flatpickrDatesDedline = document.querySelector('#flatpickr-dates-dedline'),
    flatpickrTime = document.querySelector('#flatpickr-time'),
    endFlatpickrTime = document.querySelector('#end-flatpickr-time'),
    flatpickrDateTime = document.querySelector('#flatpickr-datetime'),
    endDateTime = document.querySelector('#end-flatpickr-datetime'),
  ...
  // Date
  if (flatpickrDates) {
    flatpickrDates.flatpickr({
      monthSelectorType: 'static'
    });
  }

  // Date
  if (flatpickrDatesDedline) {
    flatpickrDatesDedline.flatpickr({
      monthSelectorType: 'static'
    });
  }
